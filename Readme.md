# 🎓 College Societies Management Console
...
* **Global Command Palette:** Hit `Ctrl+K` or `Cmd+K` to instantly summon an animated search modal for lightning-fast navigation across the app.
* **Fluid Animations:** Powered by Framer Motion, featuring staggered list renders, 3D hover tilts on society cards, animated progress bars, and a dynamic sun/moon theme toggle.
